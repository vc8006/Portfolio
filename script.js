...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (projectId && projects[projectId]) {
    ...
    document.getElementById("project-title").textContent = project.title + " - John Doe";
    ...
    document.getElementById("github-link").onclick = () => location.href = project.github;
    document.getElementById("live-demo-link").onclick = () => location.href = project.liveDemo;
  } else {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  for (const [key, project] of Object.entries(projects)) {
    ...
    projectElement.innerHTML = `
      ...
      ${project.new_page ? 'onclick="window.open(\'' + project.github + '\', \'_blank\')"' : 'onclick="window.open(\'project-template.html?project=' + key + '\', \'_blank\')"'}>
      View Project
    </button>
...
const technicalSkills = {
  ...
  "Web technologies": ["HTML", "CSS", "Bootstrap", "Django-Drf", "Express.js", "Node.js", "ReactJs", "Git", "NumPy", "pandas", "jQuery", "AJAX"],
  "Database Management": ["MySQL", "MongoDB"],
  // "Miscellaneous": ["Git", "NumPy", "pandas", "jQuery", "AJAX"]
};

// Get the experience container
const experienceContainer = document.querySelector('.experience-details-container');
